...
def six_conv_slices(kernel_size):
    ...
    x = Conv2D(256, kernel_size=(100, 1), strides=(1, 1), activation='sigmoid', padding="same")(main_input)
    x = Conv2D(256, kernel_size=(7, 7), strides=(1, 1), activation='sigmoid', padding="same")(x)
