...
def simple_identification(input_shape, kernel_size, filters, learning_rate):
    ...
    x = Conv2D(64, kernel_size=kernel_size, strides=(1, 1), activation='relu', padding="same")(main_input)
    x = Conv2D(256, kernel_size=kernel_size, strides=(1, 1), activation='relu', padding="same")(x)
    x = Conv2D(256, kernel_size=kernel_size, strides=(1, 1), activation='relu', padding="same")(x)
    x = Conv2D(256, kernel_size=kernel_size, strides=(1, 1), activation='relu', padding="same")(x)
    x = Conv2D(256, kernel_size=kernel_size, strides=(1, 1), activation='relu', padding="same")(x)
    x = Conv2D(256, kernel_size=kernel_size, strides=(1, 1), activation='relu', padding="same")(x)
    branch_1 = Conv2D(256, kernel_size=kernel_size, strides=(1, 1), activation='relu', padding="same")(x)
    branch_1 = Conv2D(256, kernel_size=kernel_size, strides=(1, 1), activation='relu', padding="same")(branch_1)
    branch_2 = Conv2D(256, kernel_size=(1, 100), strides=(1, 1), activation='relu', padding="same")(x)
    branch_2 = Conv2D(256, kernel_size=(24, 1), strides=(1, 1), activation='relu', padding="same")(branch_2)
